...
const areas: Area[] = [
  { num: "01", title: "Erbrecht",          sub: "Nachlass & Testament",        desc: "Testamentsgestaltung, Pflichtteil, Erbauseinandersetzung sowie strukturierte Unternehmensnachfolge.", Icon: Scale },
  { num: "02", title: "Immobilienrecht",   sub: "Eigentum & WEG",              desc: "WEG-Verwaltung, Kauf- und Verkaufsabwicklung, Grundstücksrecht und notarielle Begleitung.",            Icon: Home },
  { num: "03", title: "Privates Baurecht", sub: "Verträge & Mängel",           desc: "Verbraucherbauverträge, Werkverträge, Mängelhaftung sowie Architekten- und Ingenieurrecht.",            Icon: HardHat },
  { num: "04", title: "Insolvenzrecht",    sub: "Sanierung & Restrukturierung",desc: "Eigenverwaltung, Insolvenzpläne, Gläubigervertretung und vorinsolvenzliche Restrukturierung.",         Icon: TrendingDown },
  ...
  { num: "06", title: "Gesellschaftsrecht",sub: "Gründung & M&A",              desc: "GmbH-Gründung, Gesellschaftsverträge, Umwandlungen, Geschäftsführerhaftung und Transaktionen.",        Icon: Building2 },
  { num: "07", title: "Vertragsrecht",     sub: "Gestaltung & Prüfung",        desc: "Komplexe Verträge mit Bedacht aufgesetzt — von AGB bis zu hochvolumigen Rahmenverträgen.",              Icon: FileText },
  ...
  return (
    ...
    >
      <div className="pa-head">
        <span className="pa-tag font-mono-ed">— SCHWERPUNKT</span>
        <span className="pa-num font-mono-ed">{area.num} / 12</span>
      </div>
      ...
      <div className="pa-title-wrap">
        ...
        <div className="pa-sub font-display italic">{area.sub}</div>
      </div>
      ...
      <div className="max-w-[1500px] mx-auto px-6 md:px-12 py-24 md:py-40 relative">
        <header className="reveal pa-header">
          <div className="pa-header-left">
            <div className="label-mono mb-6">03 — RECHTSGEBIETE</div>
            <h2
          ...
          <div className="pa-header-right">
            <div className="pa-header-line" aria-hidden />
        ...
        <div className="pa-grid">
          {areas.map((a, i) => (
            <AreaTile key={a.num} area={a} index={i} />
          ))}
        </div>
        ...
        <div className="pa-bottom">
          ...
          <div className="pa-bottom-note font-mono-ed">
            Sie finden Ihr Thema nicht? <a href="#kontakt" className="underline-link">Sprechen Sie uns an.</a>
          </div>
        </div>
      </div>
    </section>
